...
gt.Const.Strings.PerkDescription <- {
	...
	LegendSpecialistLuteSkill = "While using a musical instrument, gain [color=" + this.Const.UI.Color.PositiveValue + "]+10[/color] melee skill, melee defense and gain [color=" + this.Const.UI.Color.PositiveValue + "]+50%[/color] damage to armor.",
