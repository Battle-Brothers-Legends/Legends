...
gt.Const.Strings.PerkDescription <- {
	Relentless = "Don\'t slow down!\n\n[color=" + this.Const.UI.Color.Passive + "][u]Passive:[/u][/color]\n• At all times your Initiative is reduced only by [color=" + this.Const.UI.Color.PositiveValue + "]50%[/color] of your accumulated Fatigue, instead of all of it.\n• Using the \'Wait\' command will no longer give you a penalty to Initiative in the next round.",
	ReturnFavor = "Give back what they give to you tenfold!\n\n[color=" + this.Const.UI.Color.Active + "][u]Active:[/u][/color]\n• Costs 3 AP and builds up 30 fatigue.\n• For one turn, gain a [color=" + this.Const.UI.Color.PositiveValue + "]75%[/color] chance to stun and stagger any opponent missing a melee attack against you.\n• Immunities and resistances against being stunned still apply.",
	PerfectFocus = "[color=" + this.Const.UI.Color.NegativeValue + "][u]Requires:[/u] Melee Weapon or Unarmed[/color]\n\'Faster than time itself!\'\n\n[color=" + this.Const.UI.Color.Active + "][u]Active:[/u][/color]\n• Costs 0 AP and builds 10 Fatigue.\n• [color=" + this.Const.UI.Color.PositiveValue + "]Doubles[/color] your Action Points for your current turn but makes you unable to move from your position during your turn. Cannot increase available Action Points beyond [color=" + this.Const.UI.Color.PositiveValue + "]18[/color].\n• Grants immunity to being knocked back, grabbed or swallowed.\n• Each subsequent attack skill used builds [color=" + this.Const.UI.Color.NegativeValue + "]10%[/color] more Fatigue.\n• On your next turn you will be Exhausted which lowers damage by [color=" + this.Const.UI.Color.NegativeValue + "]50%[/color], increases Fatigue build-up by [color=" + this.Const.UI.Color.NegativeValue + "]100%[/color], and [color=" + this.Const.UI.Color.NegativeValue + "]halves[/color] the Action Points available during that turn.",
	Rotation = "Just like dancing with your nan when you were young.\n\n[color=" + this.Const.UI.Color.Active + "][u]Active:[/u][/color]\n• Costs 3 AP and builds up 25 fatigue.\n• Allows this character to switch places with another character while ignoring Zone of Control as long as neither character is stunned, rooted or otherwise disabled.",
	Footwork = "You've learned how to escape from sticky situations.\n\n[color=" + this.Const.UI.Color.Active + "][u]Active:[/u][/color]\n• Costs 3 AP and builds up 20 fatigue.\n• Allows you to leave a Zone of Control without triggering free attacks by using skillful footwork.",
	Debilitate = "Ankles, hands, elbows and knees, you've learned how to fight dirty to secure victory.\n\n[color=" + this.Const.UI.Color.Active + "][u]Active:[/u][/color]\n• Costs 3 AP and builds up 30 fatigue.\n• Prime your next attack to cripple a target for three turns, reducing their ability to inflict damage by [color=" + this.Const.UI.Color.NegativeValue + "]-25%[/color].",
