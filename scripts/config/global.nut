...
gt.Const.EntityType <- {
	...
	LegendBear = 139,
	LegendCatapult = 140,
	SkeletonGladiator = 141,

	BanditRabblePoacher = 142,
	BanditVermes = 143,

	SatoManhunter = 144,
	SatoManhunterVeteran = 145,

	LegendMummyLight = 146,
	LegendMummyMedium = 147,
	LegendMummyHeavy = 148,
	LegendMummyQueen = 149,
	KoboldFighter = 150,
	KoboldWolfrider = 151,

	LegendMummyPriest = 152,

	FreeCompanySpearman = 153,
	FreeCompanySlayer = 154,
	FreeCompanyFootman = 155,
	FreeCompanyArcher = 156,
	FreeCompanyCrossbow = 157,
	FreeCompanyLongbow = 158,
	FreeCompanyBillman = 159,
	FreeCompanyPikeman = 160,
	FreeCompanyInfantry = 161,
	FreeCompanyLeader = 162,
	FreeCompanyLeaderLow = 163,
